...
module.exports = [
  {
    type: 'heading',
    defaultValue: 'TeaScene'
  },
  {
    type: 'text',
    defaultValue: 'The clock, your steps and the past hour of movement across the top; below it, a gongfu tea tray by a round window that changes colour with the time of day.'
  },
  {
    type: 'section',
    items: [
      { type: 'heading', defaultValue: 'The scene' },
      {
        type: 'select',
        messageKey: 'SceneTime',
        defaultValue: '0',
        label: 'Colours',
        description: 'Automatic follows the clock: morning from 5, afternoon from 11, evening from 5 PM, night from 9 PM.',
        options: [
          { label: 'Follow the time of day', value: '0' },
          { label: 'Always morning', value: '1' },
          { label: 'Always afternoon', value: '2' },
          { label: 'Always evening', value: '3' },
          { label: 'Always night', value: '4' }
        ]
      }
    ]
  },
  {
    ...
    items: [
      { type: 'heading', defaultValue: 'Time & display' },
      {
        ...
        defaultValue: true,
        label: 'Health data',
        description: 'Steps, distance and heart rate beside the clock, plus the past-hour activity sparkline. A shake shows hours slept.'
      },
      {
        type: 'select',
